    ...
    public void onClickRecordStart(View v) {
        ...
        if (mStartRecording) {
        	...
        	mButtonRecordStart.setText("Start recording");
        	 Toast.makeText(getApplicationContext(), "Thanks for you recording. An audio file of your breathing recording taken will be sent to your responsible physician.", 
